...
<head>
    ...
    <!--<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/select/1.6.0/css/select.dataTables.min.css"/>-->
     <!--<link href="css/tableSelect.css" rel="stylesheet">-->
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="charts.php">
                <div class="">
                     <img src="./images/tomo.png" width="50" height="35"/>
                </div>
                <div class="sidebar-brand-text  ">TOMOSOLUTION<sup>v2</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">have functions:</h6>
                        <a class="collapse-item" href="teminal.php">Teminal</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <?php 
                            if($result['Role']<2){ ?>
                            <a class="collapse-item" href="loguser.php">log User</a>
                        <?php    }
                        ?>
                    </div>
                </div>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
					     ...
					     if ($user->is_logged()){ ?> Hi <?php echo strtoupper($_SESSION[$user->token_login]['username']); } 
                                ?></span>
